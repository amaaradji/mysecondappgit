...
public class DefaultUxUiSelector implements UxUiSelector {
	public static final UxUi PHONE = new UxUi("phone", "nova-light", null);
	public static final UxUi TABLET = new UxUi("tablet", "nova-light", null);
	public static final UxUi DESKTOP = new UxUi("desktop", "Tahoe", "casablanca", null);
	public static final UxUi EXTERNAL = new UxUi("external", "nova-light", null);
